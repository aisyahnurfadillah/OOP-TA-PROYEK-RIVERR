...
public class DashboardMasyarakatPanel extends JPanel implements Refreshable {
    ...
    private void buildUI() {
        ...
        footer.add(btnBuat);
        JButton btnDarurat = UIHelper.buatTombol("! Laporan Darurat", new java.awt.Color(180, 0, 0));
        btnDarurat.addActionListener(e -> frame.showPanel(MainFrame.LAPORAN_DARURAT));
        footer.add(btnDarurat);
