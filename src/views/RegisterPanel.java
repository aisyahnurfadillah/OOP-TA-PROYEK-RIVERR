...
public class RegisterPanel extends JPanel implements Refreshable {
    ...
    private void buildUI() {
        ...
        g.gridx = 0; g.gridy = 0; g.insets = new Insets(0, 4, 16, 4);
        card.add(judul, g);
        ...
        g.gridy = 7; g.insets = new Insets(8, 4, 4, 4);
        ...
        g.gridy = 8; g.insets = new Insets(2, 4, 4, 4);
        card.add(btnLogin, g);
    ...
    @Override
    public void onShow() {
        txtNama.setText(""); txtEmail.setText(""); txtAlamat.setText("");
        txtPw.setText(""); txtPw2.setText("");
        lblErr.setText(" ");
    }
}
