...
public class DataStore {
    ...
    public List<Masyarakat>   getMasyarakats()   { return masyarakats; }
    public List<Admin>        getAdmins()        { return admins; }
    public List<Sungai>       getSungais()       { return sungais; }
    public List<TitikPantau>  getTitikPantaus()  { return titikPantaus; }
    public List<Laporan>      getLaporans()      { return laporans; }
    public List<Validasi>     getValidasis()     { return validasis; }
    public List<TindakLanjut> getTindakLanjuts() { return tindakLanjuts; }

    // ID generator — dipanggil Service sebelum add ke list
    public int nextIdMasyarakat() { return idMasyarakatCounter++; }
    public int nextIdAdmin()      { return idAdminCounter++; }
    public int nextIdSungai()     { return idSungaiCounter++; }
    public int nextIdTitik()      { return idTitikCounter++; }
    public int nextIdLaporan()    { return idLaporanCounter++; }
    public int nextIdValidasi()   { return idValidasiCounter++; }
    public int nextIdTindak()     { return idTindakCounter++; }
